...
2*pt(20.28606443, 382, lower.tail = FALSE) # Conduct a two tailed one-sample t-test after having calculated the degrees of freedom and the test statistic (t)
...
2*pt(2.994701367, 381, lower.tail = FALSE) # Conduct a two tailed two-sample t-test after having calculated the degrees of freedom and the test statistic (t)
